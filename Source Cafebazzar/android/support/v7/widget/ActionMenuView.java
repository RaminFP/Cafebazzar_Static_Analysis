...
public class ActionMenuView extends LinearLayoutCompat implements k, z {
    ...
    class ActionMenuPresenterCallback implements y {
    ...
    class MenuBuilderCallback implements j {
        ...
        public void onMenuModeChange(i iVar) {
            if (ActionMenuView.this.mMenuBuilderCallback != null) {
                ActionMenuView.this.mMenuBuilderCallback.onMenuModeChange(iVar);
            }
        }
    }
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i11 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                z = z && ((ActionMenuItemView) childAt).b();
    ...
    public boolean invokeItem(m mVar) {
        return this.mMenu.a((MenuItem) mVar, null, 0);
    }
