...
public class SearchView extends LinearLayoutCompat implements c {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mTextKeyListener = new OnKeyListener() {
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                ...
                if (SearchView.this.mSearchSrcTextView.isEmpty() || !z.a(keyEvent) || keyEvent.getAction() != 1 || i != 66) {
                    return false;
                }
        ...
        bk a = bk.a(context, attributeSet, l.SearchView, i, 0);
        this.mTintManager = a.a();
        LayoutInflater.from(context).inflate(a.e(l.SearchView_layout, i.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(g.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(g.search_edit_frame);
        this.mSearchPlate = findViewById(g.search_plate);
        this.mSubmitArea = findViewById(g.submit_area);
        this.mSearchButton = (ImageView) findViewById(g.search_button);
        this.mGoButton = (ImageView) findViewById(g.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(g.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(g.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(g.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.a(l.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.a(l.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.a(l.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.a(l.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.a(l.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.a(l.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.a(l.SearchView_searchIcon));
        this.mSearchHintIcon = a.a(l.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.e(l.SearchView_suggestionRowLayout, i.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.e(l.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a.a(l.SearchView_iconifiedByDefault, true));
        int c = a.c(l.SearchView_android_maxWidth, -1);
        if (c != -1) {
            setMaxWidth(c);
        }
        this.mDefaultQueryHint = a.c(l.SearchView_defaultQueryHint);
        this.mQueryHint = a.c(l.SearchView_queryHint);
        c = a.a(l.SearchView_android_imeOptions, -1);
        if (c != -1) {
            setImeOptions(c);
        }
        c = a.a(l.SearchView_android_inputType, -1);
        if (c != -1) {
            setInputType(c);
        }
        setFocusable(a.a(l.SearchView_android_focusable, true));
        a.a.recycle();
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            Rect rect = new Rect();
            boolean a = bq.a(this);
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(e.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(e.abc_dropdownitem_icon_width) : 0;
    ...
    private boolean onSuggestionsKey(View view, int i, KeyEvent keyEvent) {
        if (this.mSearchable == null || this.mSuggestionsAdapter == null || keyEvent.getAction() != 0 || !z.a(keyEvent)) {
            return false;
        }
        if (i == 66 || i == 84 || i == 61) {
