...
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    s mPendingFragmentActivityResults;
    ...
    private int allocateRequestIndex(Fragment fragment) {
        ...
        this.mPendingFragmentActivityResults.a(i, fragment.mWho);
        this.mNextCandidateRequestIndex = (this.mNextCandidateRequestIndex + 1) % MAX_NUM_PENDING_FRAGMENT_ACTIVITY_RESULTS;
        return i;
    }
    ...
    public final a getSupportMediaController() {
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        r retainLoaderNonConfig = this.mFragments.retainLoaderNonConfig();
    ...
    public final void setSupportMediaController(a aVar) {
        this.mMediaController = aVar;
        if (VERSION.SDK_INT >= 21) {
            ActivityCompat21.setMediaController(this, aVar.a.a());
        }
    }
