...
public class RecyclerView extends ViewGroup implements be, bk {
    ...
    private final bf mScrollingChildHelper;
    final State mState;
    ...
    public abstract class ItemAnimator {
        ...
        static int buildAdapterChangeFlagsForAnimations(ViewHolder viewHolder) {
            ...
            return (oldPosition == -1 || adapterPosition == -1 || oldPosition == adapterPosition) ? access$6600 : access$6600 | FLAG_MOVED;
        }
    ...
    public abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            properties.orientation = obtainStyledAttributes.getInt(d.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(d.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(d.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(d.RecyclerView_stackFromEnd, false);
        ...
        public int getLayoutDirection() {
            return bp.h(this.mRecyclerView);
        }
        ...
        public int getMinimumHeight() {
            return bp.q(this.mRecyclerView);
        }

        public int getMinimumWidth() {
            return bp.p(this.mRecyclerView);
        }
        ...
        public int getPaddingEnd() {
            return this.mRecyclerView != null ? bp.m(this.mRecyclerView) : 0;
        }
        ...
        public int getPaddingStart() {
            return this.mRecyclerView != null ? bp.l(this.mRecyclerView) : 0;
        }
        ...
        public void onInitializeAccessibilityEvent(Recycler recycler, State state, AccessibilityEvent accessibilityEvent) {
            ...
            if (this.mRecyclerView != null) {
                if (!(bp.b(this.mRecyclerView, 1) || bp.b(this.mRecyclerView, -1) || bp.a(this.mRecyclerView, -1) || bp.a(this.mRecyclerView, 1))) {
                    z = false;
                }
                a.a(z);
                if (this.mRecyclerView.mAdapter != null) {
                    a.a(this.mRecyclerView.mAdapter.getItemCount());
                }
            }
        }
        ...
        void onInitializeAccessibilityNodeInfo(f fVar) {
            onInitializeAccessibilityNodeInfo(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, fVar);
        }

        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, f fVar) {
            if (bp.b(this.mRecyclerView, -1) || bp.a(this.mRecyclerView, -1)) {
            ...
            f.a.a(fVar.b, new p(f.a.a(getRowCountForAccessibility(recycler, state), getColumnCountForAccessibility(recycler, state), isLayoutHierarchical(recycler, state), getSelectionModeForAccessibility(recycler, state))).a);
        }

        public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, f fVar) {
            fVar.a(q.a(canScrollVertically() ? getPosition(view) : 0, 1, canScrollHorizontally() ? getPosition(view) : 0, 1, false, false));
        }

        void onInitializeAccessibilityNodeInfoForItem(View view, f fVar) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt != null && !childViewHolderInt.isRemoved() && !this.mChildHelper.isHidden(childViewHolderInt.itemView)) {
                onInitializeAccessibilityNodeInfoForItem(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, view, fVar);
            }
        }
        ...
        L_0x0018:
            r0 = r6.mRecyclerView;
            r0 = android.support.v4.view.bp.b(r0, r4);
        ...
        L_0x002f:
            r3 = r6.mRecyclerView;
            r3 = android.support.v4.view.bp.a(r3, r4);
        ...
        L_0x0047:
            r0 = r6.mRecyclerView;
            r0 = android.support.v4.view.bp.b(r0, r2);
        ...
        L_0x005d:
            r3 = r6.mRecyclerView;
            r3 = android.support.v4.view.bp.a(r3, r2);
            if (r3 == 0) goto L_0x0074;
        L_0x0065:
            r3 = r6.getWidth();
            r4 = r6.getPaddingLeft();
        ...
        public void postOnAnimation(Runnable runnable) {
            if (this.mRecyclerView != null) {
                bp.a(this.mRecyclerView, runnable);
            }
        }
    ...
    public abstract class Adapter {
        ...
        public final void bindViewHolder(ViewHolder viewHolder, int i) {
            ...
            k.a(RecyclerView.TRACE_BIND_VIEW_TAG);
        ...
        public final ViewHolder createViewHolder(ViewGroup viewGroup, int i) {
            k.a(RecyclerView.TRACE_CREATE_VIEW_TAG);
    ...
    public final class Recycler {
        ...
        private void attachAccessibilityDelegate(View view) {
            if (RecyclerView.this.isAccessibilityEnabled()) {
                ...
                if (!bp.b(view)) {
                    bp.a(view, RecyclerView.this.mAccessibilityDelegate.getItemDelegate());
                }
            }
        }
                ...
                if (changedScrapViewForPosition != null) {
                    ...
                    if (changedScrapViewForPosition == null) {
                        ...
                        if (changedScrapViewForPosition == null) {
                            ...
                            z5 = z4;
                            if (z5 && !RecyclerView.this.mState.isPreLayout() && createViewHolder.hasAnyOfTheFlags(FragmentTransaction.TRANSIT_EXIT_MASK)) {
                                createViewHolder.setFlags(0, FragmentTransaction.TRANSIT_EXIT_MASK);
        ...
        final void setAdapterPositionsAsUnknown() {
            ...
            for (int i = 0; i < size; i++) {
                ViewHolder viewHolder = (ViewHolder) this.mCachedViews.get(i);
                if (viewHolder != null) {
                    viewHolder.addFlags(NotificationCompat.FLAG_GROUP_SUMMARY);
                }
            }
        }
    ...
    class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        void triggerUpdateProcessor() {
            if (RecyclerView.this.mPostUpdatesOnAnimation && RecyclerView.this.mHasFixedSize && RecyclerView.this.mIsAttached) {
                bp.a(RecyclerView.this, RecyclerView.this.mUpdateChildViewsRunnable);
                return;
            }
    ...
    class ViewFlinger implements Runnable {
        ...
        private aj mScroller;

        public ViewFlinger() {
            this.mScroller = aj.a(RecyclerView.this.getContext(), RecyclerView.sQuinticInterpolator);
        }
        ...
        public void fling(int i, int i2) {
            ...
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
            this.mScroller.a(0, 0, i, i2, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
            postOnAnimation();
        }
        ...
        void postOnAnimation() {
            ...
            bp.a(RecyclerView.this, (Runnable) this);
        }
        ...
        public void run() {
            ...
            if (ajVar.g()) {
                ...
                int b = ajVar.b();
                int c = ajVar.c();
                int i = b - this.mLastFlingX;
                int i2 = c - this.mLastFlingY;
                int i3 = 0;
                this.mLastFlingX = b;
                this.mLastFlingY = c;
                int i4 = 0;
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    k.a(RecyclerView.TRACE_SCROLL_TAG);
                    if (i != 0) {
                ...
                if (bp.a(RecyclerView.this) != 2) {
                    RecyclerView.this.considerReleasingGlowsOnScroll(i, i2);
                }
                if (!(i4 == 0 && scrollHorizontallyBy == 0)) {
                    int f = (int) ajVar.f();
                    itemCount = i4 != b ? i4 < 0 ? -f : i4 > 0 ? f : 0 : 0;
                    if (scrollHorizontallyBy == c) {
                        f = 0;
                    ...
                    if (bp.a(RecyclerView.this) != 2) {
                        RecyclerView.this.absorbGlows(itemCount, f);
                    }
                    if ((itemCount != 0 || i4 == b || ajVar.d() == 0) && (f != 0 || scrollHorizontallyBy == c || ajVar.e() == 0)) {
                        ajVar.h();
                    }
                }
                if (!(i3 == 0 && i5 == 0)) {
        ...
        public void smoothScrollBy(int i, int i2, int i3, Interpolator interpolator) {
            if (this.mInterpolator != interpolator) {
                this.mInterpolator = interpolator;
                this.mScroller = aj.a(RecyclerView.this.getContext(), interpolator);
            }
            RecyclerView.this.setScrollState(2);
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
    ...
    public abstract class ViewHolder {
        ...
        private boolean doesTransientStatePreventRecycling() {
            return (this.mFlags & 16) == 0 && bp.c(this.itemView);
        }

        private void onEnteredHiddenState() {
            this.mWasImportantForAccessibilityBeforeHidden = bp.e(this.itemView);
            bp.c(this.itemView, 4);
        }

        private void onLeftHiddenState() {
            bp.c(this.itemView, this.mWasImportantForAccessibilityBeforeHidden);
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, d.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(d.RecyclerView_layoutManager);
            obtainStyledAttributes.recycle();
            createLayoutManager(context, string, attributeSet, i, 0);
        }
        this.mScrollingChildHelper = new bf(this);
    ...
    private void consumePendingUpdateOperations() {
        ...
        if (this.mDataSetHasChangedAfterLayout) {
            k.a(TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG);
            dispatchLayout();
            k.a();
        } else if (!this.mAdapterHelper.hasPendingUpdates()) {
        } else {
            if (this.mAdapterHelper.hasAnyUpdateTypes(4) && !this.mAdapterHelper.hasAnyUpdateTypes(11)) {
                k.a(TRACE_HANDLE_ADAPTER_UPDATES_TAG);
                eatRequestLayout();
    ...
    private void onPointerUp(MotionEvent motionEvent) {
        ...
        if (ay.b(motionEvent, b) == this.mScrollPointerId) {
            b = b == 0 ? 1 : 0;
            this.mScrollPointerId = ay.b(motionEvent, b);
    ...
    private void postAnimationRunner() {
        if (!this.mPostedAnimatorRunner && this.mIsAttached) {
            bp.a((View) this, this.mItemAnimatorRunner);
    ...
    L_0x004c:
        android.support.v4.view.bp.d(r7);
    L_0x004f:
        return;
    L_0x0050:
        r2 = (r9 > r5 ? 1 : (r9 == r5 ? 0 : -1));
    ...
    private void recordAnimationInfoIfBouncedHiddenView(ViewHolder viewHolder, ItemHolderInfo itemHolderInfo) {
        viewHolder.setFlags(0, FragmentTransaction.TRANSIT_EXIT_MASK);
        ...
        if (!this.mDataSetHasChangedAfterLayout) {
            ...
            for (int i = 0; i < unfilteredChildCount; i++) {
                ...
                if (!(childViewHolderInt == null || childViewHolderInt.shouldIgnore())) {
                    childViewHolderInt.addFlags(NotificationCompat.FLAG_GROUP_SUMMARY);
                }
            }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mLeftGlow == null || this.mLeftGlow.a()) {
            ...
            paddingBottom = (this.mLeftGlow == null || !this.mLeftGlow.a(canvas)) ? 0 : 1;
        ...
        if (!(this.mTopGlow == null || this.mTopGlow.a())) {
            ...
            paddingBottom = (this.mTopGlow == null || !this.mTopGlow.a(canvas)) ? 0 : 1;
            i |= paddingBottom;
        ...
        if (!(this.mRightGlow == null || this.mRightGlow.a())) {
            ...
            paddingBottom = (this.mRightGlow == null || !this.mRightGlow.a(canvas)) ? 0 : 1;
            i |= paddingBottom;
            canvas.restoreToCount(size);
        }
    ...
    void ensureBottomGlow() {
        if (this.mBottomGlow == null) {
            this.mBottomGlow = new r(getContext());
            if (this.mClipToPadding) {
    ...
    void ensureLeftGlow() {
        if (this.mLeftGlow == null) {
            this.mLeftGlow = new r(getContext());
            if (this.mClipToPadding) {
    ...
    void ensureRightGlow() {
        if (this.mRightGlow == null) {
            this.mRightGlow = new r(getContext());
            if (this.mClipToPadding) {
    ...
    void ensureTopGlow() {
        if (this.mTopGlow == null) {
            this.mTopGlow = new r(getContext());
            if (this.mClipToPadding) {
    ...
    public View findChildViewUnder(float f, float f2) {
        for (int childCount = this.mChildHelper.getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            float n = bp.n(childAt);
            float o = bp.o(childAt);
            if (f >= ((float) childAt.getLeft()) + n && f <= n + ((float) childAt.getRight()) && f2 >= ((float) childAt.getTop()) + o && f2 <= ((float) childAt.getBottom()) + o) {
                return childAt;
            }
        }
        return null;
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        if (!(this.mLayout == null || this.mLayoutFrozen || (ay.d(motionEvent) & 2) == 0 || motionEvent.getAction() != 8)) {
            float f = this.mLayout.canScrollVertically() ? -ay.e(motionEvent, 9) : 0.0f;
            float e = this.mLayout.canScrollHorizontally() ? ay.e(motionEvent, 10) : 0.0f;
            if (!(f == 0.0f && e == 0.0f)) {
        ...
        if (this.mLayoutFrozen) {
            ...
            switch (a) {
                case 0:
                    ...
                    this.mScrollPointerId = ay.b(motionEvent, 0);
                ...
                case 1:
                    ...
                    break;
                case 2:
                    a = ay.a(motionEvent, this.mScrollPointerId);
                    if (a >= 0) {
                        b = (int) (ay.c(motionEvent, a) + 0.5f);
                        a = (int) (ay.d(motionEvent, a) + 0.5f);
                        if (this.mScrollState != 1) {
                            b -= this.mInitialTouchX;
                            a -= this.mInitialTouchY;
                            if (!z || Math.abs(b) <= this.mTouchSlop) {
                                z = false;
                            } else {
                ...
                case 5:
                    this.mScrollPointerId = ay.b(motionEvent, b);
                    i2 = (int) (ay.c(motionEvent, b) + 0.5f);
                    this.mLastTouchX = i2;
                    this.mInitialTouchX = i2;
                    i2 = (int) (ay.d(motionEvent, b) + 0.5f);
                    this.mLastTouchY = i2;
        ...
        if (dispatchOnItemTouch(motionEvent)) {
            ...
            switch (a) {
                ...
                case 1:
                    ...
                    float f = canScrollHorizontally ? -bl.a(this.mVelocityTracker, this.mScrollPointerId) : 0.0f;
                    float f2 = canScrollVertically ? -bl.b(this.mVelocityTracker, this.mScrollPointerId) : 0.0f;
                ...
                case 2:
                    a = ay.a(motionEvent, this.mScrollPointerId);
                    if (a >= 0) {
                        int c = (int) (ay.c(motionEvent, a) + 0.5f);
                        int d = (int) (ay.d(motionEvent, a) + 0.5f);
                        a = this.mLastTouchX - c;
                        int i = this.mLastTouchY - d;
                        if (dispatchNestedPreScroll(a, i, this.mScrollConsumed, this.mScrollOffset)) {
                        ...
                        if (this.mScrollState != 1) {
                            ...
                            if (!canScrollHorizontally || Math.abs(a) <= this.mTouchSlop) {
                                ...
                                b = a > 0 ? a - this.mTouchSlop : a + this.mTouchSlop;
                                z2 = true;
                            }
                        ...
                        if (this.mScrollState == 1) {
                            ...
                            if (scrollByInternal(a, i, obtain)) {
                                getParent().requestDisallowInterceptTouchEvent(true);
                                break;
                            }
                        }
                ...
                case 5:
                    this.mScrollPointerId = ay.b(motionEvent, b);
                    a = (int) (ay.c(motionEvent, b) + 0.5f);
                    this.mLastTouchX = a;
                    this.mInitialTouchX = a;
                    a = (int) (ay.d(motionEvent, b) + 0.5f);
                    this.mLastTouchY = a;
                    this.mInitialTouchY = a;
                    break;
                case 6:
    ...
    public void setAccessibilityDelegateCompat(RecyclerViewAccessibilityDelegate recyclerViewAccessibilityDelegate) {
        ...
        bp.a((View) this, this.mAccessibilityDelegate);
    }
    ...
    public void setScrollingTouchSlop(int i) {
        ...
        switch (i) {
            case 0:
                break;
            case 1:
                this.mTouchSlop = ch.a(viewConfiguration);
                return;
            default:
