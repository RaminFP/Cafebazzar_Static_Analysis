...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    private boolean mReverseLayout = DEBUG;
    ...
    public class SavedState implements Parcelable {
        ...
        SavedState(Parcel parcel) {
            ...
            this.mReverseLayout = parcel.readInt() == 1 ? true : StaggeredGridLayoutManager.DEBUG;
            this.mAnchorLayoutFromEnd = parcel.readInt() == 1 ? true : StaggeredGridLayoutManager.DEBUG;
            if (parcel.readInt() != 1) {
                z = StaggeredGridLayoutManager.DEBUG;
            }
    ...
    private boolean checkForGaps() {
        ...
        if (i == 0 && hasGapsToFix() != null) {
            ...
            FullSpanItem firstFullSpanItemInRange2 = this.mLazySpanLookup.getFirstFullSpanItemInRange(i, firstFullSpanItemInRange.mPosition, -lastChildPosition, true);
    ...
    private boolean checkSpanForGap(Span span) {
        if (this.mShouldReverseLayout) {
            ...
            return !span.getLayoutParams((View) span.mViews.get(0)).mFullSpan ? true : DEBUG;
        }
        return DEBUG;
    }
    ...
    private int fill(Recycler recycler, LayoutState layoutState, State state) {
        ...
        int i = this.mLayoutState.mInfinite ? layoutState.mLayoutDirection == 1 ? Integer.MAX_VALUE : Integer.MIN_VALUE : layoutState.mLayoutDirection == 1 ? layoutState.mEndLine + layoutState.mAvailable : layoutState.mStartLine - layoutState.mAvailable;
    ...
    private void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean z) {
        if (layoutParams.mFullSpan) {
            ...
            measureChildWithDecorationsAndMargin(view, LayoutManager.getChildMeasureSpec(this.mSizePerSpan, getWidthMode(), 0, layoutParams.width, DEBUG), LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), 0, layoutParams.height, true), z);
        } else {
            measureChildWithDecorationsAndMargin(view, LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), 0, layoutParams.width, true), LayoutManager.getChildMeasureSpec(this.mSizePerSpan, getHeightMode(), 0, layoutParams.height, DEBUG), z);
        }
    }
    ...
    private void setLayoutStateDirection(int i) {
        ...
        if (this.mShouldReverseLayout != (i == -1 ? true : DEBUG)) {
            i2 = -1;
        }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, f fVar) {
        ...
        if (layoutParams instanceof LayoutParams) {
            ...
            fVar.a(q.a(spanIndex, i2, i, i3, layoutParams2.mFullSpan, DEBUG));
            return;
        }
