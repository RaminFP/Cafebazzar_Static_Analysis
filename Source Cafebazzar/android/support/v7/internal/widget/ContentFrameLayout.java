    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode == Integer.MIN_VALUE) {
            ...
            if (!(typedValue == null || typedValue.type == 0)) {
                ...
                if (dimension > 0) {
                    i = MeasureSpec.makeMeasureSpec(Math.min(dimension - (this.a.left + this.a.right), MeasureSpec.getSize(i)), 1073741824);
                    obj = 1;
                    if (mode2 == Integer.MIN_VALUE) {
                        ...
                        if (!(typedValue == null || typedValue.type == 0)) {
                            ...
                            if (dimension > 0) {
                                i2 = MeasureSpec.makeMeasureSpec(Math.min(dimension - (this.a.top + this.a.bottom), MeasureSpec.getSize(i2)), 1073741824);
                            }
                        }
                    }
                    ...
                    if (obj == null && mode == Integer.MIN_VALUE) {
                        typedValue2 = obj3 == null ? this.c : this.b;
                        if (!(typedValue2 == null || typedValue2.type == 0)) {
                            ...
                            if (dimension2 > 0) {
                                dimension2 -= this.a.left + this.a.right;
                            }
                            if (mode2 < dimension2) {
