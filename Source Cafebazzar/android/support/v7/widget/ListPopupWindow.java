...
public class ListPopupWindow {
    ...
    public abstract class ForwardingListener implements OnTouchListener {
        ...
        private boolean onTouchForwarded(MotionEvent motionEvent) {
            ...
            if (popup == null || !popup.isShowing()) {
                ...
                boolean z2 = (a == 1 || a == 3) ? ListPopupWindow.DEBUG : true;
                if (!onForwardedEvent) {
                    return ListPopupWindow.DEBUG;
                }
                if (!z2) {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            if (z) {
                ...
                boolean z2 = (onTouchObserved(motionEvent) && onForwardingStarted()) ? true : ListPopupWindow.DEBUG;
                if (z2) {
                    long uptimeMillis = SystemClock.uptimeMillis();
                    MotionEvent obtain = MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, 0.0f, 0.0f, 0);
    ...
    class DropDownListView extends an {
        private di mClickAnimation;
        ...
        public boolean onForwardedEvent(MotionEvent motionEvent, int i) {
            ...
            if (z) {
                if (this.mScrollHelper == null) {
                    this.mScrollHelper = new x(this);
                }
                this.mScrollHelper.a(true);
                this.mScrollHelper.onTouch(this, motionEvent);
            } else if (this.mScrollHelper != null) {
                this.mScrollHelper.a((boolean) ListPopupWindow.DEBUG);
            }
            return z;
        }
    ...
    public ListPopupWindow(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mDropDownHorizontalOffset = obtainStyledAttributes.getDimensionPixelOffset(l.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = obtainStyledAttributes.getDimensionPixelOffset(l.ListPopupWindow_android_dropDownVerticalOffset, 0);
        if (this.mDropDownVerticalOffset != 0) {
            this.mDropDownVerticalOffsetSet = true;
        }
        obtainStyledAttributes.recycle();
        this.mPopup = new ag(context, attributeSet, i);
        this.mPopup.setInputMethodMode(1);
        this.mLayoutDirection = h.a(this.mContext.getResources().getConfiguration().locale);
    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            if (view3 != null) {
                ...
                view3.measure(MeasureSpec.makeMeasureSpec(this.mDropDownWidth, Integer.MIN_VALUE), 0);
        ...
        measuredHeight = this.mDropDownList.measureHeightOfChildrenCompat(makeMeasureSpec, 0, -1, maxAvailableHeight - i, -1);
        if (measuredHeight > 0) {
            i += i2;
        }
    ...
    public void show() {
        ...
        ab.a(this.mPopup, getAnchorView(), this.mDropDownHorizontalOffset, this.mDropDownVerticalOffset, this.mDropDownGravity);
