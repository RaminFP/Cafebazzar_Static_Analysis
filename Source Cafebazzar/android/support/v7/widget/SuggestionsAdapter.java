...
class SuggestionsAdapter extends ai implements OnClickListener {
    ...
    final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(g.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(b.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        if (str == null || str.length() == 0 || "0".equals(str)) {
            ...
            try {
                ...
                drawable = checkIconCache(str2);
                if (drawable == null) {
                    drawable = a.getDrawable(this.mProviderContext, parseInt);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(g.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
