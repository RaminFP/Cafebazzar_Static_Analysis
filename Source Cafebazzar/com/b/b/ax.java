...
public class ax implements LayeredSocketFactory, SocketFactory {
    private SSLContext a = null;

    private static SSLContext a() {
        try {
            SSLContext instance = SSLContext.getInstance("TLS");
            instance.init(null, new TrustManager[]{new ay(null)}, null);
            return instance;
        } catch (Exception e) {
    ...
    public boolean equals(Object obj) {
        return obj != null && obj.getClass().equals(ax.class);
    }
