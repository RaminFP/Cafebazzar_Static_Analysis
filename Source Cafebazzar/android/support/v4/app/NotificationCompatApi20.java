...
class NotificationCompatApi20 {
    ...
    public static Action[] getActionsFromParcelableArrayList(ArrayList arrayList, Factory factory, RemoteInputCompatBase.RemoteInput.Factory factory2) {
        if (arrayList == null) {
            return null;
        }
    ...
    public static boolean isGroupSummary(Notification notification) {
        return (notification.flags & NotificationCompat.FLAG_GROUP_SUMMARY) != 0;
    }
}
