...
class AdapterHelper implements Callback {
    ...
    class UpdateOp {
        ...
        public boolean equals(Object obj) {
            ...
            return this.cmd != updateOp.cmd ? AdapterHelper.DEBUG : (this.cmd == 8 && Math.abs(this.itemCount - this.positionStart) == 1 && this.itemCount == updateOp.positionStart && this.positionStart == updateOp.itemCount) ? true : this.itemCount != updateOp.itemCount ? AdapterHelper.DEBUG : this.positionStart != updateOp.positionStart ? AdapterHelper.DEBUG : this.payload != null ? !this.payload.equals(updateOp.payload) ? AdapterHelper.DEBUG : true : updateOp.payload != null ? AdapterHelper.DEBUG : true;
        }
    ...
    boolean hasAnyUpdateTypes(int i) {
        return (this.mExistingUpdateTypes & i) != 0 ? true : DEBUG;
    }
