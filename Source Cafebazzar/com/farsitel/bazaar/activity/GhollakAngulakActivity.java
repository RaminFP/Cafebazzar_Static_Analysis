...
public class GhollakAngulakActivity extends s implements OnClickListener, OnItemClickListener {
    public void onClick(View view) {
        BazaarApplication.c().getSharedPreferences("BazaarPreferences", 0).edit().putString("pref_key_custom_custom", ((EditText) findViewById(g.custom)).getText().toString() + "/%s").commit();
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        String[] stringArray = getResources().getStringArray(2131230726);
