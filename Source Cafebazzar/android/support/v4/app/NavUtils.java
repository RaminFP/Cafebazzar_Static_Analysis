...
public final class NavUtils {
    ...
    class NavUtilsImplBase implements NavUtilsImpl {
        ...
        public Intent getParentActivityIntent(Activity activity) {
            ...
            try {
                return NavUtils.getParentActivityName(activity, componentName) == null ? b.a(componentName) : new Intent().setComponent(componentName);
        ...
        public String getParentActivityName(Context context, ActivityInfo activityInfo) {
            ...
            return string != null ? string.charAt(0) == '.' ? context.getPackageName() + string : string : null;
        }
    ...
    public static Intent getParentActivityIntent(Context context, ComponentName componentName) {
        ...
        return getParentActivityName(context, componentName2) == null ? b.a(componentName2) : new Intent().setComponent(componentName2);
    }
    ...
    public static Intent getParentActivityIntent(Context context, Class cls) {
        ...
        return getParentActivityName(context, componentName) == null ? b.a(componentName) : new Intent().setComponent(componentName);
    }
