...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        bk a = bk.a(context, attributeSet, l.SwitchCompat, i, 0);
        this.mThumbDrawable = a.a(l.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = a.a(l.SwitchCompat_track);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = a.c(l.SwitchCompat_android_textOn);
        this.mTextOff = a.c(l.SwitchCompat_android_textOff);
        this.mShowText = a.a(l.SwitchCompat_showText, true);
        this.mThumbTextPadding = a.c(l.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = a.c(l.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = a.c(l.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = a.a(l.SwitchCompat_splitTrack, false);
        int e = a.e(l.SwitchCompat_switchTextAppearance, 0);
        if (e != 0) {
            setSwitchTextAppearance(context, e);
        }
    ...
    private int getThumbOffset() {
        return (int) (((bq.a(this) ? 1.0f - this.mThumbPosition : this.mThumbPosition) * ((float) getThumbScrollRange())) + 0.5f);
    }
    ...
    private int getThumbScrollRange() {
        ...
        Rect a = this.mThumbDrawable != null ? ak.a(this.mThumbDrawable) : ak.a;
        return ((((this.mSwitchWidth - this.mThumbWidth) - rect.left) - rect.right) - a.left) - a.right;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mTrackDrawable != null) {
            ...
            if (a == null || a.isEmpty()) {
                ...
                i6 = a.top > rect.top ? (a.top - rect.top) + i3 : i3;
    ...
    public void drawableHotspotChanged(float f, float f2) {
        ...
        if (this.mThumbDrawable != null) {
            a.a(this.mThumbDrawable, f, f2);
        }
        if (this.mTrackDrawable != null) {
            a.a(this.mTrackDrawable, f, f2);
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            Rect a = ak.a(this.mThumbDrawable);
            max = Math.max(0, a.left - rect.left);
            i6 = Math.max(0, a.right - rect.right);
        } else {
            max = 0;
        }
        if (bq.a(this)) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (getMeasuredHeight() < i3) {
            setMeasuredDimension(bp.j(this), i3);
        }
    }
    ...
    public void setChecked(boolean z) {
        super.setChecked(z);
        boolean isChecked = isChecked();
        if (getWindowToken() == null || !bp.z(this)) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(l.TextAppearance_android_typeface, -1), obtainStyledAttributes.getInt(l.TextAppearance_android_textStyle, -1));
        if (obtainStyledAttributes.getBoolean(l.TextAppearance_textAllCaps, false)) {
            this.mSwitchTransformationMethod = new android.support.v7.internal.b.a(getContext());
        } else {
    ...
    public void setThumbResource(int i) {
        setThumbDrawable(this.mTintManager.a(i, false));
    }
    ...
    public void setTrackResource(int i) {
        setTrackDrawable(this.mTintManager.a(i, false));
    }
