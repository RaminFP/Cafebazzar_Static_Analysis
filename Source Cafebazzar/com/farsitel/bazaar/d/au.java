...
public final class au extends DialogFragment implements OnTimeSetListener {
    public final Dialog onCreateDialog(Bundle bundle) {
        Calendar instance = Calendar.getInstance();
        int i = instance.get(11);
        int i2 = instance.get(12);
        SharedPreferences sharedPreferences = BazaarApplication.c().getSharedPreferences("BazaarPreferences", 0);
        int i3 = sharedPreferences.getInt("schedule_update_start_hour", 1);
        int i4 = sharedPreferences.getInt("schedule_update_start_minute", 0);
    ...
    public final void onTimeSet(TimePicker timePicker, int i, int i2) {
        if (timePicker.isShown()) {
            ...
            edit.putInt("schedule_update_start_hour", intValue);
            edit.putInt("schedule_update_start_minute", intValue2);
            edit.commit();
            an.a();
        }
    }
