...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    boolean mPendingSpanCountChange = DEBUG;
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        while (i6 < i2) {
            ...
            if (this.mOrientation == 1) {
                measureChildWithDecorationsAndMargin(view2, childMeasureSpec3, childMeasureSpec4, DEBUG, DEBUG);
            } else {
                measureChildWithDecorationsAndMargin(view2, childMeasureSpec4, childMeasureSpec3, DEBUG, DEBUG);
            }
        ...
        if (obj != null) {
            ...
            while (i7 < i2) {
                ...
                childMeasureSpec = LayoutManager.getChildMeasureSpec(this.mCachedBorders[layoutParams.mSpanIndex + layoutParams.mSpanSize] - this.mCachedBorders[layoutParams.mSpanIndex], 1073741824, 0, this.mOrientation == 0 ? layoutParams.height : layoutParams.width, DEBUG);
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, f fVar) {
        ...
        if (layoutParams instanceof LayoutParams) {
            ...
            if (this.mOrientation == 0) {
                ...
                fVar.a(q.a(spanIndex, spanSize, spanGroupIndex, 1, z, DEBUG));
                return;
            }
            ...
            fVar.a(q.a(spanGroupIndex, 1, spanIndex2, spanSize2, z2, DEBUG));
            return;
        }
