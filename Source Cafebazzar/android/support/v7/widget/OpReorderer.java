...
class OpReorderer {
    ...
    void swapMoveRemove(List list, int i, UpdateOp updateOp, int i2, UpdateOp updateOp2) {
        int i3;
        UpdateOp updateOp3;
        int i4 = 0;
    ...
    void swapMoveUpdate(List list, int i, UpdateOp updateOp, int i2, UpdateOp updateOp2) {
        Object obj;
        Object obj2 = null;
        if (updateOp.itemCount < updateOp2.positionStart) {
            updateOp2.positionStart--;
