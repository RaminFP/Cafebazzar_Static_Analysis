...
final class FragmentManagerImpl extends FragmentManager implements an {
        ...
        public void onAnimationEnd(Animation animation) {
            if (this.mView != null && this.mShouldRunOnHWLayer) {
                this.mView.post(new Runnable() {
                    public void run() {
                        bp.a(AnimateOnHWLayerIfNeededListener.this.mView, 0, null);
                    }
                });
            }
        ...
        public void onAnimationStart(Animation animation) {
            if (this.mView != null) {
                ...
                if (this.mShouldRunOnHWLayer) {
                    this.mView.post(new Runnable() {
                        public void run() {
                            bp.a(AnimateOnHWLayerIfNeededListener.this.mView, 2, null);
                        }
                    });
                }
            }
    ...
    static boolean shouldRunOnHWLayer(View view, Animation animation) {
        return (VERSION.SDK_INT >= 19 && bp.g(view) == 0 && bp.x(view) && modifiesAlpha(animation)) ? true : HONEYCOMB;
    }

    private void throwException(RuntimeException runtimeException) {
        Log.e(TAG, runtimeException.getMessage());
        Log.e(TAG, "Activity state:");
        PrintWriter printWriter = new PrintWriter(new e(TAG));
        if (this.mHost != null) {
            try {
    ...
    final an getLayoutInflaterFactory() {
        return this;
    }
    ...
    L_0x014d:
        r0 = r11.mView;
        android.support.v4.view.bp.a(r0, r3);
    L_0x0152:
        r0 = r11.mHidden;
    ...
    L_0x01ef:
        r1 = r11.mView;
        android.support.v4.view.bp.a(r1, r3);
    L_0x01f4:
            ...
            if (str == null && i < 0 && (i2 & 1) == 0) {
                ...
                if (size != this.mBackStack.size() - 1) {
                    ...
                    while (i3 <= size3) {
                        ...
                        i3++;
                        transitionState = ((BackStackRecord) arrayList.get(i3)).popFromBackStack(i3 == size3 ? true : HONEYCOMB, transitionState, sparseArray3, sparseArray4);
                    }
                }
            }
            reportBackStackChanged();
                ...
                if (fragmentManagerState.mBackStack != null) {
                    ...
                    for (i2 = 0; i2 < fragmentManagerState.mBackStack.length; i2++) {
                        ...
                        if (DEBUG) {
                            ...
                            instantiate2.dump("  ", new PrintWriter(new e(TAG)), HONEYCOMB);
                        }
    ...
    public final String toString() {
        ...
        if (this.mParent != null) {
            d.a(this.mParent, stringBuilder);
        } else {
