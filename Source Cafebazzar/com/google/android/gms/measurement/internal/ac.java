...
public final class ac extends ba {
    ...
    public final void a(URL url, byte[] bArr, ad adVar) {
        super.e();
        u();
        av.a((Object) url);
        av.a((Object) bArr);
        av.a((Object) adVar);
        super.k().b(new af(this, url, bArr, adVar));
    }
    ...
    public final boolean b() {
        ...
        u();
        try {
            activeNetworkInfo = ((ConnectivityManager) super.i().getSystemService("connectivity")).getActiveNetworkInfo();
