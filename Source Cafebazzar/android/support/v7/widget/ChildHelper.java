...
class ChildHelper {
    ...
    class Bucket {
        ...
        void insert(int i, boolean z) {
            ...
            long j = (1 << i) - 1;
            this.mData = (j & this.mData) | (((-1 ^ j) & this.mData) << 1);
            if (z) {
                set(i);
            } else {
                clear(i);
        ...
        boolean remove(int i) {
            ...
            this.mData &= j ^ -1;
            j--;
            this.mData = (j & this.mData) | Long.rotateRight((j ^ -1) & this.mData, 1);
            if (this.next == null) {
                return z;
            }
            if (this.next.get(0)) {
    ...
    private int getOffset(int i) {
        ...
        if (i >= 0) {
            ...
            int i3 = i;
            while (i3 < childCount) {
                int countOnesBefore = i - (i3 - this.mBucket.countOnesBefore(i3));
