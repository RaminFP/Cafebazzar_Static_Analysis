...
final class aq implements OnClickListener {
    ...
    public final void onClick(View view) {
        if (j.a().n()) {
            ...
            if (af.c(this.c.n)) {
                if (d.INSTANCE.b(new al(), j.a().b, Integer.valueOf(this.a.a), "D")) {
                    this.b.i.setAnimation(AnimationUtils.loadAnimation(this.c.i, 2130968624));
                    g gVar = this.a;
                    if (gVar.i == null || gVar.i.booleanValue()) {
                        gVar.i = Boolean.valueOf(false);
                    } else {
                        gVar.i = null;
                    }
                    this.c.a(this.b, this.a);
                    BazaarApplication.c().d();
                    i.a("/VoteDownComment/" + this.c.n);
                    return;
                }
